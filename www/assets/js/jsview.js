...
$JSView = {
    run: function(type){
        ...
        $v.select('.corpo-conteudo').innerHTML += spinnerModal;
    ...
    declareView: function(e){
        ...
        for(var obj in e){
            ...
            if(!$v.select('#' + obj)){
                ...
                $v.select('.corpo-conteudo').innerHTML += '<jsv-view id="' + obj + '"></jsv-view>';
...
//       console.groupEnd();
  ...
  //    console.time("goToView");
        ...
        console.log("%c VIEW ATIVA: "+window.history.state,"background:#fff000;color:#000;");
        localStorage.setItem("view-ativa",window.history.state);
    ...
    declareMenu: function(e){
        ...
        $v.select('.corpo-conteudo').innerHTML = '<jsv-main></jsv-main>';
    ...
    declareModal: function(e,options){
        ...
        for(var obj in e){
            ...
            if(!$v.select('#' + obj)){
                ...
                $v.select('.corpo-conteudo').innerHTML += '<jsv-modal id="' + obj + '"></jsv-modal>';
                //Put all containers out the camera
    ...
    openModal: function(e){
        ...
        eval( '$JSView.controller.' + e + '("' + e + '")' );
        //Change the url
        window.history.pushState(e, '', paginaSessao+'#'+e);
        console.log("%c MODAL ATIVO: "+window.history.state,"background:#fff000;color:#000;");
        localStorage.setItem("modal-ativo",window.history.state);
    },
